...
2026-03-08 12:00:01 INF [radarr] Checking queue... found 2 items requiring manual import (2 new)
...
```
2026-03-08 12:00:01 INF [radarr] "White.Noise.2.The.Light.2007.1080p.mkv" → IMPORTED (1 file, matched to "White Noise 2: The Light")
```
